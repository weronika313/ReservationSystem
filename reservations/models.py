...
class RegularReservation(models.Model):
    ...
    day_of__week = models.CharField(max_length=1, choices=DAYS_OF_WEEK)
    reservations = models.ManyToManyField(Reservation, through='SingleRegularReservation')


class SingleRegularReservation(models.Model):
    regular_reservation_group = models.ForeignKey('RegularReservation', on_delete=models.CASCADE)
